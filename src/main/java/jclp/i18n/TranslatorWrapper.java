...
public class TranslatorWrapper implements Translator, Attachable<Translator> {
    ...
    public void attach(Collection<? extends Translator> translators) {
        checkNotNull(translator, ERR_NO_TRANSLATOR);
        check(translator instanceof Attachable, ERR_NOT_ATTACHABLE);
        ((Attachable<Translator>) translator).attach(translators);
    }
    ...
    public void detach(Collection<? extends Translator> translators) {
        checkNotNull(translator, ERR_NO_TRANSLATOR);
        check(translator instanceof Attachable, ERR_NOT_ATTACHABLE);
        ((Attachable<Translator>) translator).detach(translators);
    }
}
