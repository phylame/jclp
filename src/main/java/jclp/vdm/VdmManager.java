...
public final class VdmManager extends ServiceManager<VdmFactory> {
    ...
    public static VdmReader getReader(String name, String input) throws IOException {
        val factory = instance.getService(name);
        return factory != null ? factory.getReader(input) : null;
    }

    public static VdmWriter getWriter(String name, String output) throws IOException {
        val factory = instance.getService(name);
