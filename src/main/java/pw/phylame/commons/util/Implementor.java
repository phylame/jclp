...
public final class Implementor<T> {
     ...
     */
    public final void load(String path, BiFunction<? super String, ? super String, ? extends String> parser) {
        lock.lock();
        try {
    ...
    public final void load(String path, ClassLoader loader, BiFunction<? super String, ? super String, ? extends String> parser) {
        lock.lock();
        try {
